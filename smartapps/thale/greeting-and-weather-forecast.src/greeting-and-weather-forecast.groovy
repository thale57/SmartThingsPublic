/**
 *  Greeting and Weather Forecast
 *
 *  Author: SmartThings
 *  Date: 2014-1-29
 */
definition(
    name: "Greeting and Weather Forecast",
    namespace: "thale",
    author: "SmartThings & Tracy Hale",
    description: "Play a greeting, followed by a weather report through your Sonos when the mode changes or other events occur",
    category: "My Apps",
...
def mainPage() {
	dynamicPage(name: "mainPage") {
		section ("Greeting before weather message") {
            input "greeting", "text", title: "What greeting would you like to hear?", required: false
        }    
...
private takeAction(evt) {
	...
	if (song) {
		sonos.playSoundAndTrack(state.sound.uri, state.sound.duration + 5, state.selectedSong, volume)
	}
